...
public partial class refurbishment : System.Web.UI.Page
{
    dboperation db = new dboperation();
    protected void Page_Load(object sender, EventArgs e)
    {
        UserControl textbooxh = Page.FindControl("header") as UserControl;
        HtmlGenericControl li = textbooxh.FindControl("Service") as HtmlGenericControl;
    ...
    private void BindBreadcrumbs()
    {
        try
        {
            ...
            ds = db.fetchds("SELECT * FROM SEO_MASTER WHERE MID=4");
