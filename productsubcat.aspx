<%@ Page Language="C#" AutoEventWireup="true" CodeFile="productsubcat.aspx.cs" Inherits="productsubcat" %>
...
<head>
    ...
    <style>
        ...
        .service-style2-detail td p {
            margin-bottom: 0;
        }

        .service-style2-detail tr:first-child {
            background: #0e5491;
            color: #fff;
        }
    ...
    <div class="page-wraper">
        ...
        <div class="page-content">
            ...
            <div class="wt-bnr-inr overlay-wraper bg-center" style="background-image: url(images/banner/2.jpg);">
                <div class="overlay-main site-bg-primary " style="opacity: 0"></div>
                <div class="container">
                    <div class="wt-bnr-inr-entry">
                        <div class="banner-title-outer">
                            <div class="banner-title-name">
                                <h2 id="scname2" runat="server" class="site-text-white"></h2>
                            </div>
                        </div>
                        <!-- BREADCRUMB ROW -->
                        <div>
            ...
            <div class="section-full p-t80 p-b80 bg-white">
                ...
                <div class="container" <%--style="background: linear-gradient(0deg, rgb(255 255 255 / 33%), rgb(255 255 255)), url(img/pb.png);"--%>>
                    <!-- TITLE START-->
                        ...
                        <div class="row wt-separator-two-part-row">
                            <div class="col-lg-12 col-md-12 wt-separator-two-part-left">
                                ...
                                <div class="section-head left wt-small-separator-outer">
                                    ...
                                    <h1 style="color: #264796; font-size: 36px;" id="cname1" runat="server"></h1>

                                    <%--<h4 id="scname3" runat="server"></h4>--%>
                                </div>
                                <!-- TITLE END-->
                            </div>
                            <div class="col-lg-7 col-md-6 wt-separator-two-part-right text-left">
                                <%-- <h2 style="color:#264796" id="cname1" runat="server"></h2>--%>
                        ...
                        <div class="services-style-two pro-detail">
                            <div class="row no-gutters">
                                ...
                                <div class="col-lg-6 col-md-12">
                                    <div class="wt-media our-story-pic width500">
                                        <img loading="lazy" id="scimage" runat="server" alt="image not available">
                                    </div>
                                </div>
                ...
                <div class="col-lg-4 col-md-6 m-t50 lbld-f">
                    <asp:Repeater ID="rpt_pgallery1" runat="server">
                        <ItemTemplate>
                            <div class="wt-media our-story-pic lblm-b">
                                <img loading="lazy" src="<%# string.IsNullOrEmpty(Eval("IMAGES").ToString())?  "http://www.placehold.it/200x150/EFEFEF/AAAAAA&text=no+image" : "admin/gallery/"+Eval("IMAGES") %>" class="w80" alt="">
                            </div>
                        </ItemTemplate>
                    </asp:Repeater>
                </div>
