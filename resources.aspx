                    ...
                    <div class="wt-bnr-inr-entry">
                        <div class="banner-title-outer">
                            <div class="banner-title-name">
                                <h1 class="site-text-white">Resources</h1>
                            </div>
                        </div>
                        <!-- BREADCRUMB ROW -->
                ...
                <div class="section-content">
                    <div class="container">
                            ...
                            <div class="service-detail-for">
                                <div class="services-large">
                                    ...
                                    <div class="services-large-info">
                                        <h3 class="services-title site-text-white">Resources</h3>
                                    </div>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="wt-box services-etc m-b30">
                            <div class="wt-info">
                                <%--<h3 class="wt-title">Welcome To KEL</h3>--%>
                                <p>
                                   Hub for all things related to the Pharma Machinery Industry. Here, you can stay updated with the latest trends and developments in the field. As the Pharma Machinery Manufacturers, We understand the importance of staying informed and continuously evolving in this dynamic industry.
                                </p>

                                <p>Our pharma machinery is designed and manufactured with precision, ensuring high-quality and reliable performance. We take pride in being leading pharma machinery manufacturers, and our machines are trusted by pharmaceutical companies worldwide. Our tablet compression machines are built to meet the diverse needs of the industry, providing efficient and precise tablet production.</p>

                                <p>We believe in transparency and providing our customers with all the necessary resources to make informed decisions. Whether you are researching the best tablet compression machines for your production needs or seeking information about our capsule filling machines, our resources section is designed to assist you in finding the information you need.</p>

                                <p>Explore our blogs to gain valuable insights, and download our brochures to get a detailed understanding of our pharma machinery. Should you have any questions or require further assistance, our team of experts is always ready to help. We are dedicated to success in the pharma industry and look forward to being trusted partner in pharma machinery solutions.
                                    Stay informed, stay ahead with our reliable and advanced tablet compression machines and capsule filling machines.
                                </p>
