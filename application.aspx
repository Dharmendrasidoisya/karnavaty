                    ...
                    <div class="wt-bnr-inr-entry">
                        <div class="banner-title-outer">
                            <div class="banner-title-name">
                                <h1 id="scname2" runat="server" class="site-text-white">Application</h1>
                            </div>
                        </div>
                        <!-- BREADCRUMB ROW -->
                        <div>
                            <ul class="wt-breadcrumb breadcrumb-style-2">
                                ...
                                <li id="scname3" runat="server">Application</li>
                            </ul>
                        </div>
                        <!-- BREADCRUMB ROW END -->
                    </div>
                        ...
                        <div class="row wt-separator-two-part-row">
                            <div class="col-lg-5 col-md-6 wt-separator-two-part-left">
                                ...
                                <div class="section-head left wt-small-separator-outer">
                                    ...
                                    <h2>Explore Our Main Application</h2>
                                </div>
                                <!-- TITLE END-->
                            </div>
                                    ...
                                    <div class="row no-gutters">
                                        <div class="col-lg-6 col-md-12">
                                            <div class="wt-media our-story-pic">
                                                <img loading="lazy" src="<%# string.IsNullOrEmpty(Eval("IMAGES").ToString())?  "http://www.placehold.it/200x150/EFEFEF/AAAAAA&text=no+image" : "admin/eproduct/"+Eval("IMAGES") %>" alt="image not available">

                                            </div>
                                        </div>
                                        <div class="col-lg-6 col-md-12">
                                            <div class="service-style2-detail">
                                                <h3 class="wt-title"><a href="<%#Eval("URL")+".aspx?aid="+Eval("ID") %>"><%#Eval("PNAME") %> </a></h3>
                                                <p><%#Eval("SORTDESC") %> </p>
                                                <a href="<%#Eval("URL")+".aspx?aid="+Eval("ID") %>"" class="site-button-link site-text-primary">Read More</a>
                                            </div>
                                        </div>
                                    </div>
                                </ItemTemplate>
